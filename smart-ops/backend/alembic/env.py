...
from app.db.base import Base  # noqa: E402  (imports Base + all models for metadata)

# this is the Alembic Config object, which provides access to values within the .ini file in use.
config = context.config

# Override the sqlalchemy.url from alembic.ini with the app's configured DATABASE_URL.
