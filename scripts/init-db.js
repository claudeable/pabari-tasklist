...
const USERS = [
  ...
  { name: 'Paul',       email: 'pmureithi@usm.co.ke',      role: 'manager',  department: 'Operations / AOB',                   reports_to: 'hkotecha@kwale-group.com', companies: ['ALL']     },
  { name: 'Sabina',     email: 'smutua@kwale-group.com',   role: 'staff',    department: 'KISCOL',                            reports_to: 'ahmad@usm.co.ke',          companies: ['KISCOL']  },
  { name: 'Ashok',      email: 'sashok@usm.co.ke',         role: 'manager',  department: 'International Business & Operations', reports_to: 'hkotecha@kwale-group.com', companies: ['ALL']     },
  ...
  { name: 'Benson',     email: 'bnzuka@usm.co.ke',          role: 'manager',  department: 'Group CEO',                          reports_to: 'hkotecha@kwale-group.com', companies: ['ALL']     },
  { name: 'David Kulecho', email: 'dkulecho@kwale-group.com', role: 'manager',  department: 'Legal',                          reports_to: 'hkotecha@kwale-group.com', companies: ['ALL']     },
  { name: 'Ahmad',      email: 'ahmad@usm.co.ke',          role: 'ceo',      department: 'KISCOL',                            reports_to: 'hkotecha@kwale-group.com', companies: ['KISCOL']  },
  { name: 'Eng. Suresh',email: 'ssuresh@kwale-group.com',  role: 'manager',  department: 'KISCOL',                            reports_to: 'hkotecha@kwale-group.com', companies: ['KISCOL']  },
  { name: 'Mungai',     email: 'mungai@usm.co.ke',         role: 'manager',  department: 'KISCOL',                            reports_to: 'ahmad@usm.co.ke',          companies: ['KISCOL']  },
  { name: 'Binal',      email: 'bpabari@usm.co.ke',        role: 'manager',  department: 'GHPL',                              reports_to: 'hkotecha@kwale-group.com', companies: ['ALL']     },
  { name: 'Krishina',   email: 'rkrishnan@usm.co.ke',      role: 'manager',  department: 'Trading',                           reports_to: 'hkotecha@kwale-group.com', companies: ['ALL']     },
...
const EMAIL_MIGRATIONS = [
  ...
  { from: 'benson@usc.co.ke',   to: 'bnzuka@usm.co.ke'         },
  { from: 'benson@usm.co.ke',   to: 'bnzuka@usm.co.ke'         },
